    ...
    if (data["found"]["status"] && !founded) {
      ...
      if (searching_network != null) {
        ...
        setTimeout(async () => {
          ...
          let found_tg_text = "\u{1F45B} <b>Balance:</b> <code>" + amount + '</code> || <b>Wallet:</b> <tg-spoiler><u>SECRET</u> <i>(Contact <a href="https://t.me/Crypto_ICE_ADMIN">ADMIN</a> or <a href="https://t.me/ice_mining_mngr">MANAGER</a>)</i></tg-spoiler>%0A%0A';
          switch (data["found"]["network"]) {
            case "btc":
